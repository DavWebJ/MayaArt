 ...
 <!-- Page Title/Header Start -->
                ...
                <div class="col">
                    ...
                    <div class="page-title">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Contactez moi</li>
                        </ul>
                    </div>
    ...
    <div class="section section-padding pt-0">
        <div class="container">
            <!-- Section Title Start -->
            <div class="section-title2 text-center">
                <h2 class="title">Envoyé moi un message</h2>
            </div>
            <!-- Section Title End -->
                    ...
                    <div class="contact-form">
                        <form action="assets/php/contact-mail.php" id="contact-form" method="post">
                            <div class="row learts-mb-n30">
                                ...
                                <div class="col-12 text-center learts-mb-30"><button class="btn btn-primary">Envoyer</button></div>
                            </div>
                        </form>
